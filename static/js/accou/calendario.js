$(function() {
    function c() {
        ...
        l.empty();
        while (!u) {
            if (s[r] == e[0].weekday) { u = true } else {
                l.append('<div class="blank"></div>');
                r++
            }
        }
        for (var c = 0; c < 42 - r; c++) {
            if (c >= e.length) { l.append('<div class="blank"></div>') } else {
                var v = e[c].day;
    ...
    var o = ["#b1c3faf1", "#67acf3f1", "#439efc", "#51a5e1", "#42b0ff", "#3094dc", "#35aaff", "#279bef", "#2e92cc", "#0290e8f2", "#21a2f3", "#0b8ad9"];
    var u = $("#calendar");
